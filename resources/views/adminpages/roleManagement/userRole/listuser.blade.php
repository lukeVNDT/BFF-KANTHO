...
<div class="modal" id="insertcat" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{URL::to('/insertuser')}}" method="POST" role="form">
          {{ csrf_field() }}
  ...
  <div class="modal-footer">
   ...
   <div class="card shadow h-100 py-2"
                    style="background:linear-gradient(to top, #396afc, #2948ff); border-radius: 10px;">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-sm-1">
                                            <i  style="font-size:50px" class="fab fa-critical-role fa-2x text-gray-300"></i>
     ...
     style="border-radius: 10px;">
                                <div class="card-body">
                                  <button class="btn btn-primary" style="float: right;" data-toggle="modal" data-target="#insertcat"><i class="fas fa-plus"></i></button>
                                    <div class="row no-gutters align-items-center">
                                        <div class="card-body">
                                          <div class="form-group">
          <p>Lọc :</p>
...
@foreach($users as $user)
         ...
         <button type="button" data-id="{{ $user->staff_id }}" data-customerid=""  class="btn btn-warning editUser">
          <i class="fas fa-user-edit"></i>

        </button>
        
        
        <button class="btn btn-primary unbanuser" data-id=""><i class="fas fa-user-check"></i></button>
       
        <button
         type="button" data-id="{{ $user->staff_id }}"  class="btn btn-danger swalbutton">
