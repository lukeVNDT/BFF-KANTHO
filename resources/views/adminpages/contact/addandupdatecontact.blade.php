    ...
    <section class="content">
      <div class="row">
        ...
        @foreach($contact as $ct)
          <form action="{{ URL::to('/addcontact/'.$ct->contact_id) }}" method="POST" role="form" enctype="multipart/form-data">
            {{ csrf_field() }}
          ...
          <div class="card">
            ...
            <!-- form start -->
              <div class="card-body">
                ...
                <p></p>
                <img src="{{ URL::to('/public/upload/contact/'.$ct->contact_img) }}" width="100px" height="100px">
                </div>
          ...
          <div class="card">
            ...
            <!-- form start -->
              <div class="card-body">
                <div class="form-group">
                  <textarea style="height: 180px;" name="map" class="form-control"  id="bando">{{ $ct->contact_map }}</textarea>
                </div>
          ...
          <div class="card">
            ...
            <!-- form start -->
              ...
              <div class="card-body">
                <div class="form-group">
                  <textarea style="height: 180px;" name="fanpage" class="form-control" id="fanpage">{{ $ct->info_fanpage }}</textarea>
                </div>
        ...
        <div class="col-md-6">
          ...
          <div class="card">
            ...
            <!-- form start -->
              <div class="card-body">
                <div class="form-group">
                  <textarea name="info_contact" class="form-control" id="contact1" >{{ $ct->info_contact }}</textarea>
                </div>
              </div>
              <!-- /.box-body -->
          </div>
          ...
          <div class="card">
            ...
            <!-- form start -->
              <div class="card-body">
                <div class="form-group">
                  <input type="number" name="phone" class="form-control" id="phone" value="{{ $ct->contact_phone }}">
                </div>
              </div>
              <!-- /.box-body -->
          </div>
          ...
          <div class="card">
            ...
            <!-- form start -->
              <div class="card-body">
                <div class="form-group">
                  <input type="email" name="contact_email" class="form-control" id="email" value="{{ $ct->contact_email }}">
                </div>
