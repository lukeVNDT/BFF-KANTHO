...
<html lang="en">
    ...
    <body>
@foreach(Session::get('information') as $infor)
        <div class="container">
            ...
            <div class="table-responsive">
                <form action="{{ URL::to('/createpayment') }}" id="create_form" method="post">       
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input disabled class="form-control" name="tong" type="text" value="{{ $infor['total_price'] }}"/>
                    </div>
                    <div class="form-group">
